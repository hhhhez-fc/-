...
- [ ] **Step 3: Implement strict manifest parsing and download mechanics**
...
- [ ] **Step 3: Implement the finite bootstrap state and cancellation**
...
- [ ] **Step 4: Run hook and launch tests and verify GREEN**
...
- [ ] **Step 3: Wire App and render the installation stage**
...
- [ ] **Step 4: Update product contracts**
...
- [ ] **Step 1: Add failing installer and workflow contract tests**
...
- [ ] **Step 3: Make installer version injection explicit**
...
- [ ] **Step 1: Run full local verification before release**
...
- [ ] **Step 3: Publish immutable GitHub Release assets**
...
- [ ] **Step 4: Replace the manifest sentinel with the real release hash**
...
- [ ] **Step 5: Re-run web verification with the final manifest**
...
- [ ] **Step 6: Commit and push the web manifest and implementation**
...
- [ ] All spec sections map to Tasks 1–5.
- [ ] `pnpm test`, `pnpm run test:a11y`, `pnpm run typecheck`, and `pnpm run build` pass.
- [ ] `dotnet test print-helper/LabelPrintHelper.sln` passes.
- [ ] Premium UI strict audit and anti-pattern scan pass.
- [ ] Installer install/launch/health/uninstall smoke test passes on Windows x64.
- [ ] Release asset bytes match the website SHA-256.
- [ ] Production manifest and JS/CSS match the verified local build.
- [ ] No automated claim is made about code signing or physical XP-420B verification.
